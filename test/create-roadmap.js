...
(async () => {
  ...
  await sql`
INSERT INTO boards (id, created_at, name) VALUES ('4c0467a7-7b5b-434c-85c5-c2a9baa4e969', '2023-09-25', 'roadmap-dev');`.execute(
    db
  );

  await sql`
INSERT INTO board_columns (id, board_id, title, position) VALUES
('6a6a1bd9-6401-4621-9038-f0db161b6201', '4c0467a7-7b5b-434c-85c5-c2a9baa4e969', 'To Do', 1),
('814a600e-8365-4c6c-aae9-68ea3e394f07', '4c0467a7-7b5b-434c-85c5-c2a9baa4e969', 'In Progress', 2),
('0cf4c61d-b276-419d-9d68-fbd9dc43f841', '4c0467a7-7b5b-434c-85c5-c2a9baa4e969', 'Done', 3);`.execute(db);

  await sql`
INSERT INTO board_items (id, column_id, title, created_at, position) VALUES
('fba8672d-c194-45cb-8418-2d58fe279f0f', '6a6a1bd9-6401-4621-9038-f0db161b6201', 'Feature 1', '2023-10-25', 1),
('64eb1893-600a-49a3-8006-1a6f752752d7', '814a600e-8365-4c6c-aae9-68ea3e394f07', 'Feature 2', '2024-02-10', 2),
('e7891a7b-bcc2-4be2-95fb-3fea5502eb49', '0cf4c61d-b276-419d-9d68-fbd9dc43f841', 'Feature 3', '2024-01-15', 3);`.execute(
    db
  );
